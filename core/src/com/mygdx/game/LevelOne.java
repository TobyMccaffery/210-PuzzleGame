...
/**
 * This class represents the second level. It is responsible for placing
 * all objects within the level at the beginning and changing their position
 * throughout
 */

public class LevelOne extends BaseLevel implements InputProcessor{
    ...
    /**
     * Constructor for the second level of the game
     * Sets the current level to this level
     */

    public LevelOne(){
        MyGdxGame.curLevel = MyGdxGame.levels.Two;
    }
    ...
    public void Create () {
        ...
        camera.update();
        tiledMap = new TmxMapLoader().load("Maps/Level5.tmx");
        ...
        lever2 = new Lever(640, 680,Textures.findRegion("LeverOff"));

        button1 = new Button(0, 680,Textures.findRegion("ButtonNotPressed"));
        lever4 = new Lever(1220, 540,Textures.findRegion("LeverOff"));

        lever5 = new Lever(220, 500,Textures.findRegion("LeverOff"));
        lever6 = new Lever(680, 600,Textures.findRegion("LeverOff"));

        lever8 = new Lever(1240, 140,Textures.findRegion("LeverOff"));
        lever7 = new Lever(100, 0,Textures.findRegion("LeverOff"));

        pressurePlate = new PressurePlate(1200, 120,Textures.findRegion("PressurePlateUp"));
        lever10 = new Lever(540, 60,Textures.findRegion("LeverOff"));
        exitPlate1 = new ExitPlate(640, 40, new TextureRegion( LevelObject.textureAtlas.findRegion("SpiralFloor")), 1);
        exitPlate2 = new ExitPlate(600, 40, new TextureRegion( LevelObject.textureAtlas.findRegion("SpiralFloor")), 2);


        door1 = new Door(940, 640, "door",Textures.findRegion("DoorClosed"));
        door2 = new Door(200, 700, "door",Textures.findRegion("DoorClosed"));
        door3 = new Door(1260, 520, "door",Textures.findRegion("DoorClosed"));
        door4 = new Door(80, 380, "door",Textures.findRegion("DoorClosed"));

        door6 = new Door(420, 500, "door",Textures.findRegion("DoorClosed"));
        door5 = new Door(720, 220, "door",Textures.findRegion("DoorClosed"));

        door7 = new Door(1080, 120, "door",Textures.findRegion("DoorClosed"));
        door8 = new Door(600, 160, "door",Textures.findRegion("DoorClosed"));


        door10 = new Door(760, 20, "door",Textures.findRegion("DoorClosed"));
        door9 = new Door(500, 20, "door",Textures.findRegion("DoorClosed"));
        ...
        healthPotion2 = new HealthPotion(580, 360, 20, 20, "HealthPotion");
        ...
        character2 = new Character(character2img, 800, 680, '2', (TiledMapTileLayer) tiledMap.getLayers().get(2));
        ...
        levelObjects.add(pressurePlate);
        ...
        drawingObjects.add(pressurePlate);
        ...
        button1.addInteractable(door3);
        lever4.addInteractable(door4);
        lever5.addInteractable(door5);
        lever6.addInteractable(door6);
        lever7.addInteractable(door7);
        lever8.addInteractable(door8);
        pressurePlate.addInteractable(door9);
...
//        font.draw(batch, "Lower left", 0, font.getLineHeight());
     ...
     * ( This method is used multiple times in create() )
     */
    ...
    /**
     * Override of touchdragged abstract class in super class
     * @param screenX passed in integer
     * @param screenY num
     * @param pointer num
     * @return false flag
